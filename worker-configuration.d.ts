/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0b43753efbcdb1b0639adebef998da53)
// Runtime types generated with workerd@1.20251001.0 2025-02-04 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RequestThrottler" | "NonceManagerV1";
	}
	interface Env {
		AUTH_DB: KVNamespace;
		EVM_AIRDROP_ACCOUNT: "0x0B10339E9b98A8e6A7122FeB5D9B97e233142833";
		APTOS_MONEY_POT_ADDRESS: "0xea89ef9798a210009339ea6105c2008d8e154f8b5ae1807911c86320ea03ff3f";
		u: string;
		MONEY_AUTH_URL: string;
		EVM_ORACLE_ACCOUNT: string;
		EVM_FAUCET_ACCOUNT: string;
		ORACLE_ACCOUNT: string;
		ORACLE_PRIVATE_KEY: string;
		ORACLE_PRIVATE_KEY_APTOS: string;
		ORACLE_PRIVATE_KEY_EVM: string;
		EVM_CREATOR_PRIVATE_KEY: string;
		EVM_HUNTER_PRIVATE_KEY: string;
		PRIVATE_KEY_0x1BD326324f2755ca5eFdb84C799eaaCC55830581: string;
		PRIVATE_KEY_0x0B10339E9b98A8e6A7122FeB5D9B97e233142833: string;
		EVM_1P_VERIFIER_ACCOUNT: string;
		PRIVATE_KEY_0xBAf5a46a2153207ff97993AC5c94179d2956ddF8: string;
		APTOS_ACCOUNT: string;
		APTOS_PRIVATE_KEY: string;
		HUNTER_ACCOUNT: string;
		HUNTER_PRIVATE_KEY: string;
		APTOS_NODE_URL: string;
		RPC_URL: string;
		MONEY_POT_ADDRESS: string;
		REQUEST_THROTTLER: DurableObjectNamespace /* RequestThrottler */;
		NONCE_V1_DO: DurableObjectNamespace /* NonceManagerV1 */;
	}
}
...
declare class URLPattern {
    constructor(input?: (string | URLPatternInit), u?: (string | URLPatternOptions), patternOptions?: URLPatternOptions);
    get protocol(): string;
    get username(): string;
    get password(): string;
    get hostname(): string;
    ...
    get search(): string;
    get hash(): string;
    test(input?: (string | URLPatternInit), u?: string): boolean;
    exec(input?: (string | URLPatternInit), u?: string): URLPatternResult | null;
}
